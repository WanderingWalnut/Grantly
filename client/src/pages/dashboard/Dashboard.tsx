        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-4 mb-3">
              <div className="p-3 bg-gradient-civic rounded-2xl shadow-lg">
            ...
            <p className="text-lg text-surface-600 civic-text max-w-2xl">
              Ready to discover your next funding opportunity? Here's your personalized grant dashboard.
            </p>
          </div>
          <div className="hidden lg:block">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-primary-100">
              <div className="text-center">
                ...
                <div className="text-sm text-surface-600">Available This Month</div>
              </div>
            </div>
          </div>
        </div>
